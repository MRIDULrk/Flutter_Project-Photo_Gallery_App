              ...
              children: [
                ...
                Padding(
                  ...
                  child: SizedBox(
                    width: size.width,
                    height: 100,
                    child: Text('There are many medicals in the city of Dhaka',
                      textAlign: TextAlign.start,
                      style:TextStyle(
                        fontSize: 24,
                        fontWeight: FontWeight.bold,
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: Text('There is many medical in the dhaka city',
                              textAlign: TextAlign.start,
                              style:TextStyle(
                                fontSize: 22,
                                color: Colors.black,
