              ...
              children: [
                ...
                Padding(
                  ...
                  child: SizedBox(
                    width: size.width,
                    height: 50,
                    child: Text('Beauty of the Ocean.',
                ...
                Padding(
                  ...
                  child: SizedBox(
                    width: size.width,
                    height: 100,
                    child: Text('A distant yet close, lover'
                        's point, where water meets the sun. And earth meets the sky.',
                      textAlign: TextAlign.start,
                      style:TextStyle(
                        fontSize: 24,
                        fontWeight: FontWeight.bold,
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: Text('The beauty of the Ocean.',
                              textAlign: TextAlign.start,
                              style:TextStyle(
                                fontSize: 32,
                                fontWeight: FontWeight.bold,
