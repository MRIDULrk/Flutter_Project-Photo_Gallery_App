              ...
              children: [
                ...
                Padding(
                  ...
                  child: SizedBox(
                    width: size.width,
                    height: 50,
                    child: Text('Sports refresh the Mind.',
                ...
                Padding(
                  ...
                  child: SizedBox(
                    width: size.width,
                    height: 100,
                    child: Text('A human activity involving physical exertion and skill as the primary focus of the activity.',
                      textAlign: TextAlign.start,
                      style:TextStyle(
                        fontSize: 24,
                        fontWeight: FontWeight.bold,
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: Text('Sports is Mendatory',
                              textAlign: TextAlign.start,
                              style:TextStyle(
                                fontSize: 32,
                                fontWeight: FontWeight.bold,
