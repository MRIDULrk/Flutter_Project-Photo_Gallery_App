              ...
              children: [
                ...
                Padding(
                  ...
                  child: SizedBox(
                    width: size.width,
                    height: 50,
                    child: Text('Lets change the world',
                ...
                Padding(
                  ...
                  child: SizedBox(
                    width: size.width,
                    height: 100,
                    child: Text('Technology is the application of scientific knowledge to the practical aims of human life.',
                      textAlign: TextAlign.start,
                      style:TextStyle(
                        fontSize: 24,
                        fontWeight: FontWeight.bold,
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: Text('Lets Chage the World',
                              textAlign: TextAlign.start,
                              style:TextStyle(
                                fontSize: 32,
                                fontWeight: FontWeight.bold,
