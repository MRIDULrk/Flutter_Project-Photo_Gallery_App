              ...
              children: [
                ...
                Padding(
                  ...
                  child: SizedBox(
                    width: size.width,
                    height: 50,
                    child: Text('Listening the music.',
                ...
                Padding(
                  ...
                  child: SizedBox(
                    width: size.width,
                    height: 100,
                    child: Text('An art of sound in time that expresses ideas and emotions in significant forms through the elements of rhythm, melody, harmony, and color.',
                      textAlign: TextAlign.start,
                      style:TextStyle(
                        fontSize: 24,
                        fontWeight: FontWeight.bold,
